...
if(subset_4_valid) {
  if (!subset_4){
    observe({
      ...
      updateSelectInput(session,"subset_1_2",label = paste('Select ',subset_4_1_value),choices = c("whole",levels(dat[,paste("subset_4.",subset_4_1_value,sep="")])),selected ="whole")
