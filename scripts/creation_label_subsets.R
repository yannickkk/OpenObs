#####subset_1#####
if (subset_1_valid){
  label1_select_1 <- substring(subset_1_names[1],10)
...
#####subset_2#####
if (subset_2_valid){
  label2_select_1 <- substring(subset_2_names[1],10)
  label2_select_2 <- "test"
...
#####subset_3#####
if (subset_3_valid){
  label3_select_1 <- substring(subset_3_names[1],10)
  label3_select_2 <- "test"
...
#####subset_4#####
if (subset_4_valid){
  label4_select_1 <- substring(subset_4_names[1],10)
  label4_select_2 <- "test"
