#####subset_1#####
if (subset_1_valid){
  label1_select_1 <<- paste("Select",substring(subset_1_names[1],10))
  label1_select_2 <<- paste("Select",label1_select_2, sep = " ")
...
#####subset_2#####
if (subset_2_valid){
  label2_select_1 <<- paste("Select",substring(subset_2_names[1],10))
  label2_select_2 <<- paste("Select",label2_select_2, sep = " ")
...
#####subset_3#####
if (subset_3_valid){
  label3_select_1 <<- paste("Select",substring(subset_3_names[1],10))
  label3_select_2 <<- paste("Select",label3_select_2, sep = " ")
...
#####subset_4#####
if (subset_4_valid){
  label4_select_1 <<- paste("Select",substring(subset_4_names[1],10))
  label4_select_2 <<- paste("Select",label4_select_2, sep = " ")
